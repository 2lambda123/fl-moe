...
if __name__ == "__main__":
    ...
    for filename in args.filename:
        ...
        tune_configs = [
            {
                "local_lr": tune.loguniform(1e-5, 1e-2),
                "local_weight_decay": tune.loguniform(1e-4, 1e-1),
                "localdropout": tune.uniform(0.2, 0.8),
                "localhiddenunits1": tune.choice([64, 128, 256, 512, 1024]),
                "localfilters1": tune.choice([16, 32, 64, 128, 256, 512]),
                "localfilters2": tune.choice([16, 32, 64, 128, 256, 512]),
            ...
            #     "flhiddenunits1": tune.choice([256, 512, 1024]),
        ...
        for tc in tune_configs:
            ...
            current_best_params = [{
                # "lr": 0.07819465656048336,
                # "fldropout": 0.44220202460442326,
                # "flhiddenunits1": 512,
                # "flfilters1": 16,
                # "flfilters2": 16,
                # "fl_weight_decay": 0.001028235288179314
                "local_lr": 0.00025,
                "local_weight_decay": 0.01,
                "localdropout": 0.5,
                "localhiddenunits1": 256,
                "localfilters1": 256,
                "localfilters2": 256
                # "moe_lr": 0.000014010675742910839,
                # "gatedropout": 0.4,
                # "gatehiddenunits1": 4,
                # "gatefilters1": 4,
                # "gatefilters2": 2,
